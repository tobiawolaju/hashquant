...
export const backendService = {
  ...
  getPortfolio: (walletAddress: string) => apiClient.get<any>(`/v1/portfolio/${walletAddress}`),
  getInsights: (walletAddress: string) => apiClient.get<any>(`/v1/insights/${walletAddress}`),
